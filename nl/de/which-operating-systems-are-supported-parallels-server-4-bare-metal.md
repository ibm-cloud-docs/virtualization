...
# Welche Betriebssysteme werden in Parallels Server 4 Bare Metal unterstützt?
...
<table border="1" cellpadding="0" cellspacing="0" width="684">
  ...
  <tbody>
    <tr>
      <th style="text-align: center;font-weight: bold;">Betriebssystem</th>
      <th style="text-align: center;font-weight: bold;">Virtuelle Maschine</th>
    ...
    <tr>
      ...
      <tr>
        <td>Windows Vista mit Service-Pack 1 und 2 (x32, x64)</td>
        <td style="text-align: center;">√</td>
        <td style="text-align: center;">x</td>
      </tr>
      <tr>
        <td>Windows XP mit Service-Pack 2 und 3 (x32, x64)</td>
        <td style="text-align: center;">√</td>
        <td style="text-align: center;">x</td>
      </tr>
      <tr>
        <td>Windows 2000 mit Service-Pack 4 (x32, x64)</td>
        <td style="text-align: center;">√</td>
        <td style="text-align: center;">x</td>
      </tr>
      <tr>
    ...
    <CAPTION>Tabelle 1. Unterstützte Betriebssysteme</CAPTION>
  </table>

\* Virtuozzo-Container werden mit Parallels Server 4 Bare Metal weder lizenziert noch unterstützt, wenn Sie {{site.data.keyword.BluSoftlayer_full}} verwenden.

Ab 23.04.2009, [Parallels Server 4 Bare Metal-Readme-Datei ![Symbol für externen Link](../../icons/launch-glyph.svg "Symbol für externen Link")](https://download.parallels.com/doc/psbm/en/Readme.pdf)
