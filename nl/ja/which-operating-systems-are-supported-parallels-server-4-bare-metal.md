...
# Parallels Server 4 Bare Metal でサポートされるオペレーティング・システムは?
...
<table border="1" cellpadding="0" cellspacing="0" width="684">
  ...
  <tbody>
    <tr>
      <th style="text-align: center;font-weight: bold;">オペレーティング・システム</th>
      <th style="text-align: center;font-weight: bold;">仮想マシン</th>
    ...
    <CAPTION>表 1. サポートされるオペレーティング・システム</CAPTION>
  </table>

\* {{site.data.keyword.cloud}} を使用する場合、Parallels Server 4 Bare Metal のライセンスは Virtuozzo Containers に適用されません。またサポートもされません。
