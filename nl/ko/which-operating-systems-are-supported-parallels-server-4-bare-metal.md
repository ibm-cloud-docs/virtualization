...
# Parallels Server 4 Bare Metal에서 지원되는 운영 체제
...
<table border="1" cellpadding="0" cellspacing="0" width="684">
  ...
  <tbody>
    <tr>
      <th style="text-align: center;font-weight: bold;">운영 체제</th>
      <th style="text-align: center;font-weight: bold;">가상 머신</th>
    ...
    <tr>
      ...
      <tr>
        <td>Windows Vista with Service Pack 1 및 2(x32, x64)</td>
        <td style="text-align: center;">√</td>
        <td style="text-align: center;">x</td>
      </tr>
      <tr>
        <td>Windows XP with Service Pack 2 및 3(x32, x64)</td>
        <td style="text-align: center;">√</td>
        <td style="text-align: center;">x</td>
      </tr>
      <tr>
    ...
    <CAPTION>표 1. 지원되는 운영 체제</CAPTION>
  </table>

\* Virtuozzo Container는 라이센스가 부여되지 않으며 {{site.data.keyword.BluSoftlayer_full}}를 사용할 때 Parallels Server 4 Bare Metal로 지원되지도 않습니다. 

2019년 4월 23일 현재, [Parallels Server 4 Bare Metal readme 파일 ![외부 링크 아이콘](../../icons/launch-glyph.svg "외부 링크 아이콘")](https://download.parallels.com/doc/psbm/en/Readme.pdf)
