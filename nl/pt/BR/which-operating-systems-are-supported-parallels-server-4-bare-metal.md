...
# Quais sistemas operacionais são suportados no Parallels Server 4 Bare Metal?
...
<table border="1" cellpadding="0" cellspacing="0" width="684">
  ...
  <tbody>
    <tr>
      <th style="text-align: center;font-weight: bold;">Sistema operacional</th>
    ...
    <tr>
      ...
      <tr>
        <td>Windows Vista com Service Pack 1 e 2 (x32, x64)</td>
        <td style="text-align: center;">√</td>
        <td style="text-align: center;">x</td>
      </tr>
      <tr>
        <td>Windows XP com Service Pack 2 e 3 (x32, x64)</td>
        <td style="text-align: center;">√</td>
        <td style="text-align: center;">x</td>
      </tr>
      <tr>
        <td>Windows 2000 com Service Pack 4 (x32, x64)</td>
        <td style="text-align: center;">√</td>
        <td style="text-align: center;">x</td>
      </tr>
      <tr>
    ...
    <CAPTION>Tabela 1. Sistemas operacionais suportados</CAPTION>
  </table>

\ * Os contêineres do Virtuozzo não são licenciados, nem suportados com o Parallels Server 4 Bare Metal quando você usa o {{site.data.keyword.BluSoftlayer_full}}.

A partir de 23/04/2009, [arquivo leia-me do Parallels Server 4 Bare Metal ![Ícone de link externo](../../icons/launch-glyph.svg "Ícone de link externo")](http://download.parallels.com/doc/psbm/en/Readme.pdf)
